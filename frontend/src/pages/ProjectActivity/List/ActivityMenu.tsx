...
export function ActivityMenu({activityId}: ActivityMenuProps) {
  ...
  return (
    <Popover.Root>
      ...
      <Popover.Portal>
        ...
        >
          <button className="w-full text-left px-2 py-1 hover:bg-gray-200 rounded-md flex items-center gap-2 text-sm hover:cursor-pointer"
          onClick={() => navigate("edit")}
          >
            <Pencil className="w-4 h-4" />
            Editar
          </button>
          <button className="w-full text-left px-2 py-1  rounded-md flex items-center gap-2 text-sm text-red-600 hover:cursor-pointer hover:bg-red-100"
